defmodule WordStash.DataCase do
  @moduledoc """
  ...
  by setting `use WordStash.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(WordStash.Repo, shared: not tags[:async])
