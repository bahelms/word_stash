...
#
#     PHX_SERVER=true bin/word_stash start
#
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/word_stash/word_stash.db
      """
  ...
  config :word_stash, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  config :word_stash, WordStash.Mailer,
