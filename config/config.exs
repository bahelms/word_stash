...
config :word_stash, WordStashWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: WordStashWeb.ErrorHTML, json: WordStashWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: WordStash.PubSub,
  live_view: [signing_salt: "Pxziu0qg"]
...
config :word_stash, WordStash.Mailer, adapter: Swoosh.Adapters.Local
